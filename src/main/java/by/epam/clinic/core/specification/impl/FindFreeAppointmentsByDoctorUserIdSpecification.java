...
public class FindFreeAppointmentsByDoctorUserIdSpecification implements Specification {
    private long userId;
    ...
    private static final String SQL_QUERY =
            "SELECT appointments.id, doctor_id, customer_id, date_time," +
                    ...
                    " doctors.user_id = '%s' AND date_time > '%s' AND customer_id IS NULL";

    public FindFreeAppointmentsByDoctorUserIdSpecification(long userId) {
        this.userId = userId;
    }
